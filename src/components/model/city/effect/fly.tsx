...
const Fly = (option: FlyOptions) => {
    ...
    const attrCindex: number[] | ArrayBuffer = [];
    const attrCnumber: number[] | ArrayBuffer = [];
    ...
    const number = parseInt((_source.distanceTo(_center) as unknown as string) + _target.distanceTo(_center));
