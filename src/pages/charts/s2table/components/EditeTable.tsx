...
import { editeTableData } from '../mocks'
...
const EditeTable = () => {
    const editeTableRef = useRef<HTMLDivElement>(null)

    const render = () => {
        const root = createRoot(editeTableRef.current as Element)

        root.render(<App data={editeTableData} />)
    }
